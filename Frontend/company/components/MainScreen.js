...
import SearchTab from "./tabs/SemuaIklanTab";
import AddMediaTab from "./tabs/IklanSaya";
...
const AppTabNavigator = createMaterialTopTabNavigator(
  {
    ...
    "Iklan Saya": {
      screen:  screenProps=> <AddMediaTab screenProps={screenProps} />,
...
export default class MainScreen extends Component {
  ...
  handleClick1() {
    this.props.navigation.navigate("CompanyCard")
  }
  ...
  render() {
    return <AppTabContainet screenProps={{onClick:this.handleClick.bind(this),onClick1:this.handleClick1.bind(this)}}/>;
  }
}
